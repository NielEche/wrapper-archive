...
export const about = async ({ params, searchParams }) => {
  ...
  return (
    ...
    <div className='bg-grayW text-black p-0 border-b border-black flex justify-between md:pt-[72px]  pt-[136px]'>
      <Link className="flex" href="/interviews">
          <h1 className='BfrikaRegular p-6 px-8 text-4xl content-center'>ABOUT</h1>
      </Link>
       ...
       <div className='bg-seaD border-t border-black flex justify-between'>
        ...
        <div className='lg:flex justify-between '>
          <div className=' lg:p-10 p-6 lg:w-2/4'>
            ...
            <p className='DMSans-Regular text-base'>For centuries, the people of Rivers state and the Niger Delta at large have expressed their identity and heritage through the vibrant, intricate patterns of their traditional wrappers. These textiles tell stories of community, culture, and history.
